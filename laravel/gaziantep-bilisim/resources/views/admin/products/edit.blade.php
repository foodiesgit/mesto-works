            ...
            @method('put')
              <div class="panel-content">
                  <div class="form-row">
                      ...
                      <div class="col-md-12 mb-3">
                        <label class="form-label" for="validationTooltip02">Detay Resmi <span class="text-danger">*</span></label>
                        <input type="file" class="form-control" name="imagedetail" id="validationTooltip02" placeholder="Detay Resmi" required>
                        <div class="valid-tooltip">
                            Detay Resmi
                        </div>
                    </div>
