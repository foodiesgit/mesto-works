...
<html lang="en">
        <meta charset="utf-8">
        <title></title>gaziantepbilişim</title>
                ...
                <div class="page-content-wrapper">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" title="gaziantepbilisim.com.tr" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                    <img src="{{asset('img/0/favicon.png')}}" class="profile-image rounded-circle">
                                </a>
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="{{asset('img/0/favicon.png')}}" class="rounded-circle profile-image">
                                            </span>
                                            <div class="info-card-text">
                                                <a class="fs-lg text-truncate text-truncate-lg" style="color:#fff;" href="http://gaziantepbilisim.com.tr">gaziantepbilisim</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700">2022 © gaziantepbilişim&nbsp;<a href='https://gaziantepbilisim.com.tr' class='text-primary fw-500' title='gaziantepbilisim' target='_blank'>gaziantepbilisim.com.tr</a></span>
                        </div>
