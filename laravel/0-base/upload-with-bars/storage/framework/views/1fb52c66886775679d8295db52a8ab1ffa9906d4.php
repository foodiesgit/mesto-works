    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
              ...
              <div class="card-body">
                <form method="get" action="<?php echo e(url('upload')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Muhtar\Desktop\works\laravel-project\upload-with-bars\resources\views/upload.blade.php ENDPATH**/ ?>