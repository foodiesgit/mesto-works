  ...
  @if(isset($details[0]->title))
    ...
    <div class="container-images">
       ...
       <div class="numbertext"></div>
                   <img src="{{ asset('uploads/projects/'.$details[0]->title.'/' . $image->getFilename()) }}" class="demo cursor" style="width:700px;height: 500px;" onclick="currentSlide(1)" alt="The Woods">
        ...
        <div class="row-slider">
            @foreach($images as $image)
                <div class="column">
                    <img src="{{ asset('uploads/projects/'.$details[0]->title.'/' . $image->getFilename()) }}" class="demo cursor" style="width:100%" onclick="currentSlide({{$loop->index+1}})" alt="The Woods">
                </div>
            @endforeach
...
<section  class="main-content">@yield('content')</section>
    <footer  id="rs-footer" class="rs-footer home9-style home12-style">@include('/partials.footer1')</footer>
