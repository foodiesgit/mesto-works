    ...
    @if(isset($details[0]->title))
      ...
      <div class="container-images">
          ...
          <div class="mySlides">
              ...
              <img src="{{ asset('uploads/activities/'.$details[0]->title.'/' . $image->getFilename()) }}" class="demo cursor" style="width:700px;height: 500px;" onclick="currentSlide(1)" alt="The Woods">
          </div>
          @endforeach
