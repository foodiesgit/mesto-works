...
Route::get('/test/{id}', [FrontendMainController::class, 'questions'])->name('questions');


Route::get('/uyelik', [FrontendJoinerController::class, 'signupForm'])->name('joiner.signup.form');
Route::get('/giris', [FrontendJoinerController::class, 'signinForm'])->name('joiner.signin.form');
Route::post('/uyelik', [FrontendJoinerController::class, 'signup'])->name('joiner.signup');
Route::post('/giris', [FrontendJoinerController::class, 'signin'])->name('joiner.signin');
...
Route::get('/cikis', [FrontendMainController::class, 'joinerLogout'])->name('joiner-logout');
