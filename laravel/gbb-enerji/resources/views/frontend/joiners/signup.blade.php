                ...
                <form action="{{route('joiner.signup')}}" method="post">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-field p-relative c-subject mb-30">
                            ...
                            {{-- <input type="number"  id="identity" name="identity" onblur="tckimlikkontorolu(this)" placeholder="TC" required> --}}
                            <p id="tc-msg"></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="contact-field p-relative c-subject mb-30">
                            <input type="number" id="phone" name="phone" min="10"  placeholder="Tel" required>
                        </div>
                    </div>
                    <div class="col-lg-12">
