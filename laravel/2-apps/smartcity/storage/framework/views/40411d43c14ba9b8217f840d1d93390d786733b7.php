...
<div class="admin-container">
    <div class="row admin-rows">
        ...
        <form action="/admin/addbanners" method="post"  class="adding-form" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mesto/Documents/works/akillikent/resources/views/pages/banners.blade.php ENDPATH**/ ?>