                            ...
                            <div class="main-menu">
                                ...
                                <nav class="rs-menu">
                                    <ul class="nav-menu">
                                        ...
                                        <li class="rs-mega-menu mega-rs current-menu-item"> <a href="#activities-block">ETKİNLİLKERİİMİZ</a></li>
                                        <li class="rs-mega-menu mega-rs current-menu-item"> <a href="#contact-block">İLETİŞİM</a> </li>
                                        <li class="rs-mega-menu mega-rs current-menu-item"> <a href="https://www.facebook.com/akillikentgbb" target="_blank">CREATİVEHUBS</a> </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
...
<?php /**PATH /home/mesto/Documents/works/akillikent/resources/views//partials/header.blade.php ENDPATH**/ ?>