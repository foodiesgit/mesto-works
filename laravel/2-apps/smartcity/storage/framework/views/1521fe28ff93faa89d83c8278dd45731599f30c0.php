...
<!-- banner -->
  <div id="rs-banner" class="rs-banner style10">
    ...
    <div class="banner-intro-box">
        ...
        <div class="intro-img">
            <img class="spine2" src="<?php echo e(asset('/images/banner/home12/intro-box.png')); ?>" alt="">
        </div>
    </div>
  </div>
<!-- categories -->
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="carousel-item">
                                    <a href="#projects-block" class="partner-item categories-item" onclick="getProjects('<?php echo e($item->category); ?>')">
                                        <img src="<?php echo e(asset('/uploads/categories/'.$item->category.'/'.$item->img)); ?>" alt="">
    ...
    const setProjects = (param) => {
        if(param.length > 0){
            for (const item of param) {
                ...
                <div class="col-lg-4 col-md-6 mb-30" data-toggle="collapse">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mesto/Documents/works/akillikent/resources/views/pages/home.blade.php ENDPATH**/ ?>