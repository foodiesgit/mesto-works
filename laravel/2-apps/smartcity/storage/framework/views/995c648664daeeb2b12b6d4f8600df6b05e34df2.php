...
const getImages  = async(param) => {
  ...
  final.forEach(item => {
    ...
    <div class="upload-img">
      ...
      <img src="<?php echo e(asset('${item.imgname}')); ?>" id="${item.imgname}" style="height:100%;">
    </div>
      `
  })
}
...
<?php echo $__env->make('layoutadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mesto/Documents/works/smartcity/resources/views/pages/uploadimage.blade.php ENDPATH**/ ?>