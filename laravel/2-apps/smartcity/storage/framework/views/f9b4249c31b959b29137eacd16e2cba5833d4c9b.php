  ...
  <!-- Menu js -->
  <script src="<?php echo e(asset('/js/rsmenu-main.js')); ?>"></script> 
  <!-- op nav js -->
  ...
  <!-- Skill bar js -->
  <script src="<?php echo e(asset('/js/skill.bars.jquery.js')); ?>"></script>
  ...
  <!-- main js -->
  <script src="<?php echo e(asset('/js/main.js')); ?>"></script><?php /**PATH C:\Users\Administrator\Desktop\Web Site\smartcity\resources\views//partials/script.blade.php ENDPATH**/ ?>