<?php $__env->startSection('content'); ?>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            <div class="logo-cat-wrap">
                                <a href="http://www.gaziantepbilisim.com.tr" target="_blank" class="logo-link">
                                    <img src="<?php echo e(asset('/images/Gaziantep bilişim logo.png')); ?>" alt="" id="ga-logo">
                                </a>
                            </div> 
                        </div>
    ...
    <div class="main-content">
        <div class="rs-banner style5">
            <img src="<?php echo e(asset('/images/biappyaz.jpeg')); ?>" alt="" style="width: 100vw;">
        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 md-mb-30">
                        <div class="service-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                            <div class="content-part">
                                <span class="icon-part"><img src="<?php echo e(asset('/images/market.png')); ?>"/></span>
                    ...
                    <div class="col-lg-3 md-mb-30">
                        <div class="service-item wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2000ms">
                            <div class="content-part">
                                <span class="icon-part"><img src="<?php echo e(asset('/images/game.png')); ?>"/></span>
                    ...
                    <div class="col-lg-3 md-mb-30">
                        <div class="service-item wow fadeInUp" data-wow-delay="900ms" data-wow-duration="2000ms">
                            <div class="content-part">
                                <span class="icon-part"><img src="<?php echo e(asset('/images/facebook.png')); ?>"/></span>
                    ...
                    <div class="col-lg-3">
                        <div class="service-item wow fadeInUp" data-wow-delay="900ms" data-wow-duration="2000ms">
                            <div class="content-part">
                                <span class="icon-part"><img src="<?php echo e(asset('/images/unity.png')); ?>"/></span>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 md-mb-30">
                        <div class="service-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                            <div class="content-part">
                                <span class="icon-part"><img src="<?php echo e(asset('/images/o1.png')); ?>"/></span>
                    ...
                    <div class="col-lg-4 md-mb-30">
                        <div class="service-item wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2000ms">
                            <div class="content-part">
                            <span class="icon-part"><img src="<?php echo e(asset('/images/o2.png')); ?>"/></span>
                    ...
                    <div class="col-lg-4 md-mb-30">
                        <div class="service-item wow fadeInUp" data-wow-delay="900ms" data-wow-duration="2000ms">
                            <div class="content-part">
                            <span class="icon-part"><img src="<?php echo e(asset('/images/o3.png')); ?>"/></span>
            ...
            <div class="container">
                ...
                <div class="row mb-5">
                    <div class="col-lg-4 md-mb-30">
                        <div class="service-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                            <div class="content-part">
                                <span class="icon-part"><img src="<?php echo e(asset('/images/extra.png')); ?>" width=200/></span>
            ...
            <div class="container mb-5">
                <div class="row couter-area">
                    ...
                    <div class="col-lg-3 col-md-6 sm-mb-30">
                        <div class="counter-item text-center">
                            <h2 id="losts" class="cl-g">0</h2>
                            <h4 class="title mb-0">Kaybdenler</h4>
                        </div>
                    </div>
        ...
        <div class="col-lg-10 col-md-10 col-sm-10" style="margin:auto;">
            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    <?php if(isset($winner)): ?>
                        <?php $__currentLoopData = $winner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
    ...
    <script>
        ...
        const getCounter = async () => {
            ...
            document.getElementById('losts').innerText = allData.filter(item => item.status === 'Kaybetti').length
            document.getElementById('invalids').innerText = allData.filter(item => item.status === 'Geçersiz').length
        }
        getCounter()
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Muhtar\Desktop\works\gazibilisim\biappyaz\resources\views/pages/home.blade.php ENDPATH**/ ?>