    ...
    <div class="main-content">
        <section class="register-section pt-100 pb-100">
            <div class="container" style="padding:20px 40px">
                ...
                KVKK
                Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. Kişisel Verilerin Korunması ve İşlenmesi Hakkında Aydınlatma Metni
                Gizlilik Politikası
                Aşağıdaki bilgiler Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş.'nin, size talep ettiğiniz hizmetleri sağlamak için veya bize kişisel bilgilerinizi vermeyi tercih ettiğinizde, kişisel bilgilerinizi ne şekilde topladığını ve kullanabileceğini açıklamaktadır.
                Bilgi Toplama
                Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. gizliliğinize tamamen saygı duymaktadır ve kişisel bilgilerinizi korumak için elinden gelen çabayı sarf edecektir. Genel olarak, bu web sitesine göz atmanız sırasında herhangi bir kişisel bilgi vermeniz gerekmeyecektir.
                ...
                Kişisel bilgileriniz sadece Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş.'nin: belirli belgelere ve/veya hizmetlere yönelik taleplerinizi karşılamak, istenen bilgileri göndermek, bir başvuruyu işleme koymak, bir işlemi yürütme gibi iş amaçları doğrultusunda kullanılacaktır.
                Bununla birlikte, Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. kişisel bilgilerinizin belirli kısımlarını yasal yetkililere, kolluk kuvvetlerine ve devlet görevlilerine talep edildiği takdirde sağlayabilir ve Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. kişisel bilgilerinizin belirli kısımlarını, Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş.'ni ve halkı korumak için makul şekilde gerekli gördüğünde, son derece kısıtlı bir alıcı kapsamı içinde açıklayabilir. Kişisel bilgilerinizi sağladığınızda, bu tür olayların meydana gelebilmesini önceden görmüş ve kabul etmiş sayılacaksınız.
                Bilgilerinizin Üçüncü Taraflara Açıklanması
                Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş.'nin web sitesi üçüncü tarafların web sitelerine veya web adreslerine çok sayıda bağlantı içermektedir; Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. kişisel bilgilerinizi söz konusu üçüncü taraflara açıklamayacak ve üçüncü tarafların gizlilik politikaları nedeniyle sorumlu tutulmayacaktır.
                Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş., hizmetlere yönelik taleplerinizi daha iyi şekilde yerine getirebilmek için kişisel bilgilerinizi paylaşabilir. Elbette Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. kişisel bilgilerinizi sadece sizin rızanızla paylaşacaktır.
                Bilgilerinizin Güvenliği
                Çocukların Kişisel Gizliliğini Destekleme
                Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. 13 yaşın altındaki çocuklardan kasıtlı olarak kişisel bilgiler toplamaz veya onlara kişisel bilgileri için talepler göndermez.
                Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. Tüm Hakları Saklıdır.
                Kişisel Verilerin Korunması Hakkında Aydınlatma Metni
                Değerli Ziyaretçimiz,
                Öncelikle başvurumuza gösterdiğiniz ilgi için teşekkür ederiz. Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. olarak kişisel verilerinizin korunmasını ve kişisel verilerin korunması mevzuatına uygun davranmayı önemsiyoruz. Başvuru için kayıt yaptırmadan önce lütfen aşağıda yer alan bilgilendirme metnini okuyunuz.
                Adınız, soyadınız, iletişim bilgileriniz ve adres bilgilerinizi Talep, istek, öneri, şikâyet vs. yaptırmanız sırasında kayıt formu vasıtasıyla otomatik olarak elde edilmekte ve işlenmektedir. Başvuru sırasında fotoğraf gönderilmesi halinde, görsel kayıtlarınız (fotoğraflarınız) da işlenebilecektir. Kişisel verilerinizin bir bölümü hizmet talebinizi işleme almak ve etkinlik yönetimi amacıyla ilgili birimlerimize ve etkinlik hizmet sağlayıcılarına aktarılabilecektir. Başvuru kayıt formu ile elde edilen kişisel verileriniz, operasyonel ve hizmetlerin karşılanması amacıyla Türkiye Cumhuriyeti’nde bulunan Gaziantep Bilişim ve Akıllı Kent Teknolojileri A.Ş. bünyesindeki sunuculara aktarılmakta ve bünyesinde saklanmaktadır.
                ...
                İşbu aydınlatma metnine ilişkin sorularınız veya yukarıda belirtilen haklarınıza ilişkin talepleriniz için bize info@gaziantepbilisim.com.tr veya https://gaziantepbilisim.com.tr/iletisim aracılığıyla ulaşabilirsiniz. Tarafınıza otuz günü aşmamak kaydıyla mümkün olan en kısa sürede dönüş yapılacaktır.
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Muhtar\Desktop\works\gazibilisim\biappyaz\resources\views/pages/rules.blade.php ENDPATH**/ ?>