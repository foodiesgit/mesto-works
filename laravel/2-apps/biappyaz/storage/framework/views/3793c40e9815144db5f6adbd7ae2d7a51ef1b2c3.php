    ...
    <h3 class="file-upload-title">Dosya Yükleme</h3>
        <form id="fileUploadForm" method="POST" action="/fileupload" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input id="file" name="file" type="file" class="form-control" style="height:44px;">
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Muhtar\Desktop\works\laravel-project\biappyaz\resources\views/pages/fileupload.blade.php ENDPATH**/ ?>