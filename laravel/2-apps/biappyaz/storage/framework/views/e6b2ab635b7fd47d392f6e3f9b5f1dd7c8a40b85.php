<?php $__env->startSection('content'); ?>
    ...
    <script>
            ...
            for (const item of param) {
                list.innerHTML +=  `
                    <tr class="${item.status} cts-list">
                        ...
                        <td class="col-lg-1">
                            <div class="btn btn-danger" onclick="deleteContestant(${item.id},'${item.filename}', event)">
        ...
        const deleteContestant = async (id,filename, event) => {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mesto/Documents/works/biappyaz/resources/views/pages/contestants.blade.php ENDPATH**/ ?>