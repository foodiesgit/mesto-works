                    ...
                    <div class="styled-form">
                        <form action="" method="post" id="register-form" enctype="multipart/form-data">                               
                            ...
                            <div class="row clearfix">                                    
                                ...
                                <div class="form-group col-lg-12">
                                    <input type="tel" id="user" name="phone" minlength="11" maxlength="11" placeholder="0-000-000-00-00" required pattern="[0-9]+" oninvalid="this.setCustomValidity('Telefon 11 karekter ve rakam olmalıdır!')" oninput="setCustomValidity('')" required>
                                </div>    
                                <div class="form-group col-lg-12">
                                    <input type="text" id="puser" name="identity" value="" placeholder="TC" minlength="11"  maxlength="11" required pattern="[0-9]+" oninvalid="this.setCustomValidity('TC 11 karekter ve rakam olmalıdır!')" oninput="setCustomValidity('')" required>
                                </div>    
                                <div class="form-group col-lg-12">
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 text-center">
                                <button type="submit" id="submit" disabled class="readon disabled-btn"><span class="txt">Gönder</span></button>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Muhtar\Desktop\works\laravel-project\biappyaz\resources\views/pages/register.blade.php ENDPATH**/ ?>