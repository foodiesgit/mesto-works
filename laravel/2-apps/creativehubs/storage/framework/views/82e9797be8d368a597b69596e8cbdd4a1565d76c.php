  ...
  <div class="container" style="padding:30px;">
    ...
    <div class="add-node-inputs-con">
        ...
        <select name="source" id="source-node" style="margin:10px; min-width:60px;">
            <option value="" disabled selected>Select</option>
            <?php $__currentLoopData = $source; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($item->source); ?>"><?php echo e($item->source); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      <label for="aggre">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mesto/Documents/works/creativehubs/resources/views/addstyle.blade.php ENDPATH**/ ?>