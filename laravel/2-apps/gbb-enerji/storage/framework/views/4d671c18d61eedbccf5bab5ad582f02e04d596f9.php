                                ...
                                <div class="slider-content s-slider-content mt-150">
                                    <h5 data-animation="fadeInDown" data-delay=".4s">HOŞGELDİNİZ </h5>
                                        ...
                                        <div class="col-xl-2 col-lg-2 text-right d-none d-lg-block mt-15 mb-15">
                                            <a href="<?php echo e(route('test')); ?>" class="btn ss-btn">ÇEVRE KORUMA TESTİ</a>
                                        </div>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row services-08-item--wrapper mt-0">
                        <div class="col-lg-4 col-md-4">
                            <a href="<?php echo e(route('subject1')); ?>">
                ...
                <div class="row services-08-item--wrapper mt-0">
                        <div class="col-lg-4 col-md-4">
                            <a href="<?php echo e(route('subject2')); ?>">
                                <div class="services-08-item">
                                    <div class="services-08-thumb index-logo">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <a href="<?php echo e(route('subject3')); ?>">
                                <div class="services-08-item">
                                    <div class="services-08-thumb index-logo">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12 col-md-12 text-center">
                        <a href="<?php echo e(route('contact')); ?>" class="btn ss-btn">Bizimle İletişime Geçin</a>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\works\application\gbb-enerji\resources\views/frontend/index.blade.php ENDPATH**/ ?>