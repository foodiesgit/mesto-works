          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                ...
                <select class="form-control" id="role_id" name="role_id">
                  ...
                  <option value="{{$role->id}}" {{ old('role_id') && old('role_id') == $role->id ? 'selected' : '' }}>{{$role->name}}</option>
                  @endforeach
                </select>
                @error('role_id')
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('phone') is-invalid @enderror" placeholder="Telefon" name="phone" id="phone" required value="{{ old('phone') }}" autocomplete="off" />
                @error('phone')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Emaili" name="email" id="email" value="{{ old('email') }}" autocomplete="off" />
                @error('email')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('tc') is-invalid @enderror" placeholder="TC" name="tc" id="tc" value="{{ old('tc') }}" autocomplete="off" />
                @error('tc')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-4">
              <div class="form-group">
                <label for="password">Şifresi <span class="text-danger text-small">*</span></label>
