...
<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
  	...
  	<div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold my-1 mr-5">Kategori Ekle</h5>
        <!--end::Page Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
          ...
          <li class="breadcrumb-item">
            <a href="" class="text-muted">Kategori Ekle</a>
          </li>
        </ul>
        <!--end::Breadcrumb-->
    	</div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" id="top_id" name="top_id">
                  <option value="" {{ old('top_id') ? '' : 'selected' }}>Üst Kategorisi Yok</option>
                  @foreach($categories as $category)
                  <option value="{{$category->id}}" {{ old('top_id') && old('top_id') == $category->id ? 'selected' : '' }}>{{$category->name}}</option>
                  @endforeach
                </select>
                @error('top_id')
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Kategori Adı" name="name" id="name" required value="{{ old('name') }}" maxlength="255" />
                @error('name')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" class="form-control @error('order') is-invalid @enderror" placeholder="Kategori Adı" name="order" id="order" required value="{{ old('order') ? old('order') : 0 }}" maxlength="255" />
                @error('order')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control @error('class_name') is-invalid @enderror" placeholder="Class Adı" name="class_name" id="class_name" value="{{ old('class_name') }}" maxlength="255" />
                @error('class_name')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
              	...
              	<input class="form-control" type="color" value="{{ old('hex_color_code') ? old('hex_color_code'): '#3699FF' }}" id="hex_color_code" name="hex_color_code" />
