					...
					<div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
						<div class="align-items-center text-center container p-0">
							<div class="page-logo width-mobile-auto m-0 align-items-center text-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0" style="width: auto;">
								<a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center text-center">
							...
							<div class="row">
								<div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto mr-auto">
									...
									<div class="card p-4 rounded-plus bg-faded">
										...
										<form id="js-login" novalidate="" method="post" action="{{ route('admin.post.login') }}">
											@csrf

											<div class="form-group">
												<label class="form-label" for="username">E-Mail</label>
												<input type="email" id="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="E-Mail" value="{{ old('email') }}" required />
												@error('email')
