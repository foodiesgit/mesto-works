...
<html lang="tr">
	...
	<body class="mod-bg-1 mod-nav-link ">
				...
				<div class="page-content-wrapper">
					...
					<footer class="page-footer" role="contentinfo">
						<div class="d-flex align-items-center flex-1 text-muted">
							<span class="hidden-md-down fw-700">2021 © Gaziantep Bilişim</span>
						</div>
						<div>
							<ul class="list-table m-0">
								<li class="pl-3"><a href="{{ env('APP_URL') }}" target="_blank" class="text-secondary fw-700">Siteye Git</a></li>
							</ul>
						</div>
					</footer>
					<!-- END Page Footer -->
        ...
        <script>
            ...
            document.getElementById('js-date').innerHTML = ''
            document.getElementById('js-date').innerHTML = fr.format(new Date())
        </script>
	</body>
	<!-- END Body -->
</html>
