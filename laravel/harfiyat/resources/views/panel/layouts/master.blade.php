...
<body class="g-sidenav-show   bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
        {{-- <img src="/assets/panel/img/logo-ct.png" class="navbar-brand-img h-100" alt="..."> --}}
        <img  class="navbar-brand-img h-100" style="max-height: 4rem;" src="uploads/hafriyat.png">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  {{ $M1 }}" href="{{ route('dashboard') }}">
            ...
            <span class="nav-link-text ms-1">Yeni Belge Girişi</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  {{ $M2 }}" href="{{ route('documents') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Belge Durumları</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  {{ $M3 }}" href="{{ route('credicart') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @if ($M4 == "active")
          <li class="nav-item">
            <a class="nav-link  {{ $M4 }}" >
              ...
              <span class="nav-link-text ms-1">Kabul Belgesi Ödeme</span>
            </a>
          </li>
        @endif
        @if (@$M5 == "active")
          <li class="nav-item">
            <a class="nav-link  {{ $M5 }}" >
              ...
              <span class="nav-link-text ms-1">Belge Düzenleme</span>
            </a>
          </li>
        @endif
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Kullanıcı Ayarları</h6>
        </li>
        {{-- <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ route('exit') }}">
            ...
            <span class="nav-link-text ms-1">Oturumu Kapat</span>
          </a>
        </li>
      </ul>
    </div>
    {{-- <div class="sidenav-footer mx-3 mt-3 pt-3">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="full-background" style="background-image: url('/assets/panel/img/curved-images/white-curved.jpeg')"></div>
        <div class="card-body text-left p-3 w-100">
          <div class="icon icon-shape icon-sm bg-white shadow text-center mb-3 d-flex align-items-center justify-content-center border-radius-md">
            <i class="ni ni-diamond text-dark text-gradient text-lg top-0" aria-hidden="true" id="sidenavCardIcon"></i>
          </div>
          <div class="docs-info">
            <h6 class="text-white up mb-0">HAFRİYAT</h6>
            <p class="text-xs font-weight-bold">Siteye Dön</p>
            <a href="{{ URL::to('/') }}" target="_blank" class="btn btn-white btn-sm w-100 mb-0">WEB SİTESİ</a>
          </div>
        </div>
      </div>
    </div> --}}
  ...
  <main class="main-content mt-1 border-radius-lg">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Hafriyat</a></li>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item px-3 d-flex align-items-center">
              <a href="{{ route('documents') }}" class="nav-link text-body p-0">
                <i class="fa fa-eye cursor-pointer"></i>
              </a>
            </li>
            {{-- <li class="nav-item px-3 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body p-0">
                <i class="fa fa-file-upload fixed-plugin-button-nav cursor-pointer"></i>
              </a>
            </li> --}}
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        ...
                        <h6 class="text-sm font-weight-normal mb-1">
                          <span class="font-weight-bold">
                             <i class="fa fa-sign-out"></i> Oturumu </span> Kapat
                        </h6>
                      </div>
                    </div>
                  </a>
    ...
    <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('assets/panel/img/curved-images/curved0.jpg'); background-position-y: 50%;">
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <i class="fa fa-ticket fa-2x" style="color: #000"></i>
              {{-- <img src="/assets/panel/img/bruce-mars.jpg" alt="..." class="w-100 border-radius-lg shadow-sm"> --}}
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Toplam Belgeler</p>
                    <h5 class="font-weight-bolder mb-0">
                      @yield('TOTAL_DOC')
                      {{-- <span class="text-success text-sm font-weight-bolder">@yield('TOTAL_DOC')%</span> --}}
                    </h5>
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Kabul Edilen</p>
                    <h5 class="font-weight-bolder mb-0">
                      @yield('SUCCESS_DOC')
                      {{-- <span class="text-success text-sm font-weight-bolder">@yield('SUCCESS_DOC')%</span> --}}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Geri Çevrilen</p>
                    <h5 class="font-weight-bolder mb-0">
                      @yield('RED_DOC')
                      {{-- <span class="text-danger text-sm font-weight-bolder">@yield('RED_DOC')%</span> --}}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Bekleyen</p>
                    <h5 class="font-weight-bolder mb-0">
                      @yield('CONTINUE_DOC')
                      {{-- <span class="text-danger text-sm font-weight-bolder">@yield('CONTINUE_DOC')%</span> --}}
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-12">
              <div class="copyright text-center text-sm text-muted text-lg-left">
                ...
                <a href="https://gaziantepbilisim.com.tr" class="font-weight-bold" target="_blank">Gaziantep Bilişim ve Akıllı Kent Teknolojileri</a>
  ...
  <script src="/assets/panel/js/plugins/chartjs.min.js"></script>
  <script src="/assets/panel/js/plugins/Chart.extension.js"></script>
  <script>
  ...
  $.ajax({
    ...
    success: function (data) {
      if( data > 0 )
      {
        ...
        {
          // Swal.fire(
          //   'Onaylanmış Hafriyat Belgesi',
          //   'Onay almış ama henüz ödemesi yapılmamış belge tespit edildi',
          //   'question'
          // )
            $.notify("Onay almış ama henüz ödemesi yapılmamış belge tespit edildi", "info");
        }
        // $.notify("Onay almış ama henüz ödemesi yapılmamış belge tespit edildi", "error");
