      ...
      <aside class="left">
        ...
        <div class="left-con">
          ...
          <!-- not user side -->
            ...
            <nuxt-link to="/home/account/detailsaccount" v-if="!checkS3 && !checkB4" class="title-list account-list" exact-active-class="account-active">
